...
<p align="center">
  ...
  실제 시험 준비 흐름에 맞춰 설계된 브라우저 기반 학습 도구.
</p>
...
이 흐름은 **무조건 자동 반영**이 아니라, 제안 유형에 따라 다음처럼 나뉩니다.

- 사용자는 문제 번호와 현재 문맥이 채워진 이슈를 쉽게 만들 수 있습니다
- 정답은 직접 바뀌지 않습니다
- 정답 관련 제안은 근거 기반 검토 요청으로만 수집합니다
- 해설 보완 이슈는 자동 PR이 생성될 수 있지만, 여전히 관리자 승인 후 머지되어야 반영됩니다
- 문제 구조/정답 관련 이슈는 수동 검토 후 별도 PR로 반영됩니다
