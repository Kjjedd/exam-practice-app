...
export function PdfUploadPanel() {
  ...
  return (
    <section className="rounded-[2rem] border border-ink/10 bg-white px-6 py-8 shadow-sm sm:px-8 sm:py-10">
      ...
      <p className="mt-4 max-w-3xl text-sm leading-7 text-ink/75 sm:text-base">
      ...
      <div className="mt-8 grid gap-4 lg:grid-cols-[1.2fr_0.8fr]">
        <div className="rounded-[1.75rem] border border-dashed border-ink/20 bg-mist px-6 py-8">
        ...
        <aside className="rounded-[1.75rem] border border-ink/10 bg-ink px-6 py-8 text-white shadow-sm">
          <h2 className="text-2xl font-semibold tracking-tight">이 단계에서 하는 일</h2>
